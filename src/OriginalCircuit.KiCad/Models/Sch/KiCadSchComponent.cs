...
public sealed class KiCadSchComponent : ISchComponent
{
    ...
    /// <inheritdoc />
    public IReadOnlyList<ISchPin> Pins { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchLine> Lines { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchRectangle> Rectangles { get; set; } = [];
    ...
    /// <inheritdoc />
    public IReadOnlyList<ISchPolyline> Polylines { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchPolygon> Polygons { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchArc> Arcs { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchCircle> Circles { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchBezier> Beziers { get; set; } = [];
    ...
    /// <inheritdoc />
    public IReadOnlyList<ISchImage> Images { get; set; } = [];

    /// <inheritdoc />
    public IReadOnlyList<ISchParameter> Parameters { get; set; } = [];
    ...
    /// </summary>
    public IReadOnlyList<KiCadSchComponent> SubSymbols { get; set; } = [];
